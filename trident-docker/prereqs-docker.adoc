...
summary: 在部署Trident之前，您必须在主机上安装和配置必要的协议先决条件。 
---
= 部署先决条件
:hardbreaks:
:allow-uri-read: 
...
* 确认您的部署满足所有要求link:../trident-get-started/requirements.html["要求"]。
* 请确认您已安装受支持的 Docker 版本。如果您的 Docker 版本已过时， https://docs.docker.com/engine/install/["安装或更新它"^] 。
+
[source, console]
----
docker --version
