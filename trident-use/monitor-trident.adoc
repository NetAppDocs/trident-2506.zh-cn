...
* Trident AutoSupport 不会收集或传输个人身份信息 (PII) 或个人信息。它附带 https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf["最终用户许可协议"^]，不适用于 Trident 容器图像本身。您可以了解有关 NetApp 对数据安全和信任承诺的更多信息 https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf["此处"^]。
